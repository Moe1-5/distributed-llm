...
| Relay receipt RPC reset handoff | `RELAY_RECEIPT_RPC_STREAM_RESET_HANDOFF.md` | Exact legacy-versus-receipt RPC boundary, correlated evidence, ruled-out causes, controlled isolation matrix, and next-agent fix decision tree |
