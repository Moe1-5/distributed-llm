...
| Windows managed WSL packaging | `WINDOWS_MANAGED_WSL_PACKAGING.md` | Sprint 15 backend-bundled existing-WSL boundary, packaged participant evidence tools, managed operator configuration, versioned launcher contract, schema-four manifest binding, sanitized acceptance report, and clean-Windows runbook |
