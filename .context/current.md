...
- Sprint 06 started: current serving model is one backend process per serving participant, and `/models` now separates registry availability from complete-compatible-route runnable status.
