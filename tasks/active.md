...
| Sprint 17 | `tasks/sprints/sprint-17-coverage-aware-layer-allocation.md` | Recommend useful layer ranges and select complete routes despite overlapping or redundant providers. |
