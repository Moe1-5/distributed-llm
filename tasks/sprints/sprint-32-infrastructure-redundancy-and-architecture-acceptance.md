...
- Status: the focused evidence and manifest suites and all 451 backend tests pass. The final validator now rejects unbound, out-of-order, or session-incomplete off-mode evidence; generating the report and completing the remaining physical matrix still require the two Windows devices and independent infrastructure hosts.

### 2026-08-23 - Require every cross-sprint physical scenario
